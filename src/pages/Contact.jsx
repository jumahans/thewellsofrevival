...
function Contact() {
  ...
  const [formType, setFormType] = useState("message"); // "message" or "prayer"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <i className="fas fa-map-marker-alt text-2xl text-blue-600 mt-1 flex-shrink-0"></i>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <i className="fas fa-phone text-2xl text-blue-600 mt-1 flex-shrink-0"></i>
                    <div>
                      <h4 className="font-semibold text-gray-800">Call Us</h4>
                      <a href="tel:+254727502355" className="text-blue-600 hover:underline">
                        +254 727 502 355
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <i className="fas fa-envelope text-2xl text-blue-600 mt-1 flex-shrink-0"></i>
                    <div>
                      <h4 className="font-semibold text-gray-800">Email Us</h4>
                      <a href="mailto:thewellsofrevival.ke@gmail.com" className="text-blue-600 hover:underline">
                        thewellsofrevival.ke@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <i className="fas fa-clock text-2xl text-blue-600 mt-1 flex-shrink-0"></i>
                    <div>
                      <h4 className="font-semibold text-gray-800">Service Times</h4>
                      <div className="text-gray-600 space-y-1">
                        <p>First Service: <strong>8:00 AM – 9:30 AM</strong></p>
                        <p>Second Service: <strong>10:00 AM – 11:30 AM</strong></p>
                        <p>Discipleship: <strong>11:45 AM – 12:30 PM</strong></p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  {[
                    { icon: "fab fa-facebook", href: "https://facebook.com", color: "hover:text-blue-600" },
                    { icon: "fab fa-instagram", href: "https://instagram.com", color: "hover:text-pink1-500" },
                    { icon: "fab fa-youtube", href: "https://youtube.com", color: "hover:text-red-500" },
              ...
              <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  {formType === "message" ? (
                    ...
                    <>
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-5">
                        <p className="text-blue-800 text-sm flex items-center">
                          <i className="fas fa-lock mr-2"></i>
                          Your prayer request is confidential and shared only with our prayer team.
                        </p>
                      </div>

                      <div>
                        <label htmlFor="prayer-name" className="block text-sm font-medium text-gray-700 mb-1">
                          Name (Optional)
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label htmlFor="prayer-email" className="block text-sm font-medium text-gray-700 mb-1">
                          Email (Optional)
                        </label>
                        <input
                          type="email"
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          id="prayer-updates"
                          name="prayerUpdates"
                          checked={formData.prayerUpdates}
                          onChange={handleInputChange}
                          className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="prayer-updates" className="text-sm text-gray-700">
                          Send me prayer updates and encouragement
                        </label>
                      </div>
                    </>
                  )}
                  ...
                  >
                    {formType === "message" ? "Send Message" : "Submit Prayer Request"}
                  </button>
                </form>
              </div>
            </div>
